<div class="flex justify-end">
    ...
    ?>
        <a class="mr-1 bg-yellow-600 text-yellow-800 py-2 px-3 rounded-lg hover:bg-yellow-500 hover:text-yellow-200" href="index.php?connect=signin">Créer un compte</a>
